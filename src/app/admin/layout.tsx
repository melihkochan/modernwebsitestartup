  ...
  const renderSidebarContent = () => (
    <div className="flex flex-col justify-between h-full bg-[rgba(10,10,10,0.45)] backdrop-blur-md">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="mx-6 p-4 rounded-xl border border-[var(--border-default)] bg-[rgba(10,10,10,0.25)] flex items-center gap-3">
          <div className="relative flex h-10 w-10 shrink-0">
            ...
            <div className="relative h-10 w-10 rounded-full bg-gradient-to-tr from-[var(--accent-primary)] to-purple-500 flex items-center justify-center text-white font-bold font-mono text-sm">
              Z
            </div>
          </div>
          <div className="flex flex-col gap-0.5 min-w-0">
            <span className="text-xs font-bold text-[var(--text-primary)] truncate">Zehragn</span>
      ...
      <div className="p-4 border-t border-[var(--border-default)]">
        <Link
          href="/"
          className="flex items-center gap-3 px-4 py-2.5 text-xs font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-overlay)] rounded-lg transition-all"
        >
